...
abstract: "GK791 Data Science \"Visualisierung\" (POSA)\\clearpage"
...
{r, results='asis'}
tab1<-cbind(apply(state.x77,2,median),apply(state.x77,2,mean),apply(state.x77,2,IQR),apply(state.x77,2,sd))
colnames(tab1)<- c("Median","Mittelwert","IQR","Standardabweichung")
xtable(tab1)
